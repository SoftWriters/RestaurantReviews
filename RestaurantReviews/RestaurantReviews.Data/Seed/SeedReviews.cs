...
namespace RestaurantReviews.Data.Seed
{
    ...
    {
        public static Review HomerPositiveTacoBell = new Review()
        {
        ...
        public static Review MargeNegativeTacoBell = new Review()
        {
        ...
        public static Review LisaNegativeWendys = new Review()
        {
