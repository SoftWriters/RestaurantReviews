...
namespace RestaurantReviewsApi.UnitTests.ValidatorTests
{
    ...
    {
        private IValidator<RestaurantSearchApiModel> RestaurantSearchApiModelValidator => new RestaurantSearchApiModelValidator();
        ...
        public void RestaurantSearchApiModelStateValidation()
        {
            ...
            var validation = RestaurantSearchApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "State");
            ...
            validation = RestaurantSearchApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "State");
        ...
        public void RestaurantSearchApiModelZipCodeValidation()
        {
            ...
            var validation = RestaurantSearchApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "ZipCode");
            Assert.NotNull(validation);
            Assert.Equal("The ZipCode field be a valid value.", validation.ErrorMessage);

            apiModel.ZipCode = "12345";
            validation = RestaurantSearchApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "ZipCode");
            Assert.Null(validation);
        }
        ...
        public void RestaurantSearchApiModelNameValidation()
        {
            ...
            var validation = RestaurantSearchApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "Name");
            Assert.NotNull(validation);
            ...
            validation = RestaurantSearchApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "Name");
            Assert.Null(validation);
        }
        ...
        public void RestaurantSearchApiModelCityValidation()
        {
            ...
            var validation = RestaurantSearchApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "City");
            Assert.NotNull(validation);
            ...
            validation = RestaurantSearchApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "City");
            Assert.Null(validation);
        }
        ...
        public void RestaurantSearchApiModelNullValidation()
        {
            ...
            var validation = RestaurantSearchApiModelValidator.Validate(apiModel).Errors
            ...
            validation = RestaurantSearchApiModelValidator.Validate(apiModel).Errors
                .FirstOrDefault(x => x.ErrorMessage == "At least one of the following fields must have a value: Name, AddressLine1, City, State, ZipCode.");
            Assert.Null(validation);
