...
namespace RestaurantReviewsApi.UnitTests.ValidatorTests
{
    ...
    {
        private IValidator<RestaurantApiModel> _restaurantApiModelValidator => new RestaurantApiModelValidator();

        [Fact]
        public void RestaurantApiModelNameValidation()
        {
            var apiModel = new RestaurantApiModel();
            var validation = _restaurantApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "Name");
            Assert.NotNull(validation);
            Assert.Equal("Name is required.", validation.ErrorMessage);

            apiModel.Name = HelperFunctions.RandomString(101);
            validation = _restaurantApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "Name");
            Assert.NotNull(validation);
        ...
        {
            var apiModel = new RestaurantApiModel();
            var validation = _restaurantApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "City");
            Assert.NotNull(validation);
            Assert.Equal("City is required.", validation.ErrorMessage);

            apiModel.City = HelperFunctions.RandomString(101);
            validation = _restaurantApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "City");
            Assert.NotNull(validation);
        ...
        {
            var apiModel = new RestaurantApiModel();
            var validation = _restaurantApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "State");
            Assert.NotNull(validation);
            Assert.Equal("State is required.", validation.ErrorMessage);

            apiModel.State = HelperFunctions.RandomString(4);
            validation = _restaurantApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "State");
            Assert.NotNull(validation);
        ...
        public void RestaurantApiModelZipCodeValidation()
        {
            ...
            var validation = _restaurantApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "ZipCode");
            Assert.NotNull(validation);
            Assert.Equal("The ZipCode field be a valid value.", validation.ErrorMessage);

            apiModel.ZipCode = "12345";
            validation = _restaurantApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "ZipCode");
            Assert.Null(validation);
        }
        ...
        public void RestaurantApiModelPhoneValidation()
        {
            ...
            var validation = _restaurantApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "Phone");
            Assert.NotNull(validation);
            Assert.Equal("The Phone field be a valid value.", validation.ErrorMessage);

            apiModel.Phone = "4129229229";
            validation = _restaurantApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "Phone");
            Assert.Null(validation);
        }
        ...
        public void RestaurantApiModelEmailValidation()
        {
            ...
            var validation = _restaurantApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "Email");
            Assert.NotNull(validation);
            Assert.Equal("The Email field be a valid value.", validation.ErrorMessage);

            apiModel.Email = "valid@validemail.com";
            validation = _restaurantApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "Email");
            Assert.Null(validation);
        }
        ...
        public void RestaurantApiModelAddressLine1Validation()
        {
            ...
            var validation = _restaurantApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "AddressLine1");
            Assert.NotNull(validation);
            ...
            validation = _restaurantApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "AddressLine1");
            Assert.Null(validation);
        }
        ...
        public void RestaurantApiModelAddressLine2Validation()
        {
            ...
            var validation = _restaurantApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "AddressLine2");
            Assert.NotNull(validation);
            ...
            validation = _restaurantApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "AddressLine2");
            Assert.Null(validation);
        }
        ...
        public void RestaurantApiModelWebsiteValidation()
        {
            ...
            var validation = _restaurantApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "Website");
            Assert.NotNull(validation);
            ...
            validation = _restaurantApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "Website");
            Assert.Null(validation);
        }
        ...
        public void RestaurantApiModelDescriptionValidation()
        {
            ...
            var validation = _restaurantApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "Description");
            Assert.NotNull(validation);
            ...
            validation = _restaurantApiModelValidator.Validate(apiModel).Errors.FirstOrDefault(x => x.PropertyName == "Description");
            Assert.Null(validation);
        }
    }
}
